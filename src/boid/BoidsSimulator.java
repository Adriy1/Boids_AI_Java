...
public void affiche() {
  ...
  for (Boid b : this.bb.tabBoid) {
    ...
    this.gui.addGraphicalElement(new gui.Rectangle((int) (b.p.getX()+b.v.x),(int) (b.p.getY()+b.v.y) ,Color.red,Color.red,10)); // permet de representer le vecteur vitesse
